...
function calculateResults() {
  ...
  const views = parseFloat(document.getElementById('facebookViews').value.replace(/,/g, '')) || 0;
...
document.getElementById('facebookViews').addEventListener('input', calculateResults);
